...
Public Class SqlAuditoriaRepository
     ...
     SELECT CAST(SCOPE_IDENTITY() AS INT);"
        ...
        Using cn As New SqlConnection(_cs)
            Using cmd As New SqlCommand(sql, cn)
                ...
                cmd.Parameters.Add("@Obs", SqlDbType.VarChar, 500).Value = If(a.Observaciones, "")
    ...
    Public Function EnsureStockSube(idAgencia As Integer) As Integer _
        Implements IAuditoriaRepository.EnsureStockSube
        ...
        BEGIN
            ...
            VALUES (100, @IDAgencia, 0, 1, 0, 0, SYSDATETIME(), NULL);
        END;
